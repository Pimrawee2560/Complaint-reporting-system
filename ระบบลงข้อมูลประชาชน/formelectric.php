...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `electrical_form`(`id`, `Date`, `Electrical`, `Gender`, `Age`, `Career`, `Evaluate_1`, `Evaluate_2`, `Evaluate_3`, `Evaluate_4`, `Evaluate_5`, `Suggestion`) VALUES (NULL,'$Date','$Electrical','$Gender','$Age','$Career','$Evaluate_1','$Evaluate_2','$Evaluate_3','$Evaluate_4','$Evaluate_5','$Suggestion')";
...
<body>
    ...
    <div>
        <label for="Electrical">งานบริหารการศึกษา</label><span class="required">*</span><br><br>
        <input type="radio" name="Electrical" value="แจ้งซ่อมบำรุงไฟฟ้าสาธารณะ" required> แจ้งซ่อมบำรุงไฟฟ้าสาธารณะ<br>
        <input type="radio" name="Electrical" value="แจ้งซ่อมบำรุงเสียงตามสาย" required> แจ้งซ่อมบำรุงเสียงตามสาย<br>
    </div><br>
    <div>
    ...
    <div>
        <label for="Evaluate_4">4. มีช่องทางการติดต่อแจ้งไฟฟ้าขัดข้อง หลายช่องทาง เช่น โทรศัพท์สำนักงาน กลุ่มไลน์ </label><span class="required">*</span><br><br>
    ...
    <div>
        <label for="Evaluate_5">5. เจ้าหน้าที่ให้บริการด้วยความเต็มใจ และรวดเร็ว </label><span class="required">*</span><br><br>
