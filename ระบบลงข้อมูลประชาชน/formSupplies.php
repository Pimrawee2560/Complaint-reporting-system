...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `supplies_form`(`id`, `Date`, `Supplies`, `Gender`, `Age`, `Career`, `Evaluate_1`, `Evaluate_2`, `Evaluate_3`, `Evaluate_4`, `Evaluate_5`, `Suggestion`) VALUES (NULL,'$Date','$Supplies','$Gender','$Age','$Career','$Evaluate_1','$Evaluate_2','$Evaluate_3','$Evaluate_4','$Evaluate_5','$Suggestion')";
...
<body>
    ...
    <div>
        <label for="Supplies">งานพัสดุ</label><span class="required">*</span><br><br>
        <input type="radio" name="Supplies" value="จัดซื้อจัดจ้าง" required> จัดซื้อจัดจ้าง<br>
    </div><br>
    <div>
    ...
    <div>
        <label for="Evaluate_5">5. การดำเนินการจัดซื้อ/จัดจ้างมีความถูกต้อง เป็นธรรม โปร่งใส </label><span class="required">*</span><br><br>
