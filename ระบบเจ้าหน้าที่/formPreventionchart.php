...
$sql = "SELECT Evaluate_1, Evaluate_2, Evaluate_3, Evaluate_4, Evaluate_5 FROM disaster_prevention_and_relief_form";
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        series: [{
            ...
            name: '4. เจ้าหน้าที่มีความรู้และความเข้าใจในการให้บริการ ',
            data: Object.values(data['Evaluate_4'])
        }, {
            name: '5. เจ้าหน้าที่มีความตั้งใจและทุ่มเทในการทำงาน ',
