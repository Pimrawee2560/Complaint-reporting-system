...
$sql = "SELECT Evaluate_1, Evaluate_2, Evaluate_3, Evaluate_4, Evaluate_5 FROM finance_and_accounting_form";
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'คะแนนความพึงพอใจแบบฟอร์มงานการเงินและบัญชี'
        },
        xAxis: {
        ...
        series: [{
            ...
            name: '5. มีการเบิกจ่ายเงินถูกต้องตามระเบียบ กฎหมาย ',
