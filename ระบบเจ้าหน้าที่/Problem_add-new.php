...
$sql = "SELECT name, email, phone, user_image FROM user_form WHERE name = '$user_name'";
...
$row = mysqli_fetch_assoc($result);
      if (isset($_POST["submit"])) {
         ...
         $sql = "INSERT INTO `crud`(`id`, `Problems`,`Name_user`, `Problem_type`, `Problem_details`, `Image_file`, `Problem_location`, `Problem_Date`, `Problem_update`) VALUES (NULL,'$Problems','$Name_user','$Problem_type','$Problem_details','$Image_file','$Problem_location','$Problem_Date','$Problem_update')";
