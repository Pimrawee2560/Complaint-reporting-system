...
$sql = "SELECT Evaluate_1, Evaluate_2, Evaluate_3, Evaluate_4, Evaluate_5 FROM legal_form";
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'คะแนนความพึงพอใจแบบฟอร์มงานนิติกร'
        },
        xAxis: {
        ...
        series: [{
            ...
            name: '4. ระยะเวลาในการให้บริการมีความเหมาะสม',
