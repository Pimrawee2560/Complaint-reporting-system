...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `legal_form`(`id`, `Date`, `Legal`, `Gender`, `Age`, `Career`, `Evaluate_1`, `Evaluate_2`, `Evaluate_3`, `Evaluate_4`, `Evaluate_5`, `Suggestion`) VALUES (NULL,'$Date','$Legal','$Gender','$Age','$Career','$Evaluate_1','$Evaluate_2','$Evaluate_3','$Evaluate_4','$Evaluate_5','$Suggestion')";
...
<body>
    ...
    <div>
        <label for="Legal">งานนิติกร</label><span class="required">*</span><br><br>
        <input type="radio" name="Legal" value="การยื่นเรื่องร้องทุกข์/ร้องเรียน" required> การยื่นเรื่องร้องทุกข์/ร้องเรียน<br>
        <input type="radio" name="Legal" value="การขอข้อมูลข่าวสารทางราชการ" required> การขอข้อมูลข่าวสารทางราชการ<br>
        <input type="radio" name="Legal" value="การขอใช้งาน Internet" required> การขอใช้งาน Internet<br>
        <input type="radio" name="Legal" value="งานจดทะเบียนพาณิชย์" required> งานจดทะเบียนพาณิชย์<br>
        <input type="radio" name="Legal" value="งานกิจการหอพัก" required> งานกิจการหอพัก<br>
    </div><br>
    <div>
    ...
    <div>
        <label for="Evaluate_4">4. ระยะเวลาในการให้บริการมีความเหมาะสม </label><span class="required">*</span><br><br>
