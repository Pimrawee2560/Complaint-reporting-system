...
$sql = "SELECT Evaluate_1, Evaluate_2, Evaluate_3, Evaluate_4, Evaluate_5 FROM educationform";
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'คะแนนความพึงพอใจแบบฟอร์มกองการศึกษา ศาสนา และวัฒนธรรม'
        },
        xAxis: {
        ...
        series: [{
            name: '1. อาคาร สถานที่มีความเป็นระเบียบเรียบร้อย',
            data: Object.values(data['Evaluate_1'])
        }, {
            name: '2. คุณภาพของครูผู้จัดการสอน',
            data: Object.values(data['Evaluate_2'])
        }, {
            name: '3. คุณภาพ/ทักษะของผู้เรียน',
            data: Object.values(data['Evaluate_3'])
        }, {
            name: '4. คุณภาพผู้เรียนมีทักษะในการดำรงชีวิต',
            data: Object.values(data['Evaluate_4'])
        }, {
            name: '5.แหล่งเรียนรู้ในศูนย์พัฒนาเด็กเล็กและชุมชนมีเพียงพอ',
