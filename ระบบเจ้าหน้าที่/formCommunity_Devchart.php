...
$sql = "SELECT Evaluate_1, Evaluate_2, Evaluate_3, Evaluate_4, Evaluate_5 FROM community_development_form";
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'คะแนนความพึงพอใจแบบฟอร์มงานพัฒนาชุมชน'
        },
        xAxis: {
        ...
        series: [{
            ...
            name: '4. เจ้าหน้าที่สามารถให้บริการ เช่น ตอบคำถาม ขี้แจงข้อสงสัย ให้คำแนะนำ อย่างถูกต้อง',
            data: Object.values(data['Evaluate_4'])
        }, {
            name: '5. เจ้าหน้าที่มีการให้บริการเหมือนกันทุกราย โดยไม่เลือกปฏิบัติ',
