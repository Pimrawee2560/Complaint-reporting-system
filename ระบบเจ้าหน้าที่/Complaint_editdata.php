            ...
            <div class="form-group mb-3">
               ...
               <div class="form-group mb-3">
                  ...
                  <select class="form-select" name="Problem_type" value="<?php echo $row['Problem_type'] ?>" required  >
                     ...
                     <option value="option1" <?php if($row['Problem_type'] == 'option1') echo 'selected'; ?>>ปัญหาถนนคับแคบชำรุดเสียหาย</option>
                     <option value="option2" <?php if($row['Problem_type'] == 'option2') echo 'selected'; ?>>ปัญหาทางเท้ามีจำนวนไม่เพียงพอและไม่ได้มาตรฐาน</option>
                     <option value="option3" <?php if($row['Problem_type'] == 'option3') echo 'selected'; ?>>ปัญหาการติดตั้งไฟฟ้าสาธารณะให้แสงสว่างยังไม่ทั่วถึง</option>
                     <option value="option1" <?php if($row['Problem_type'] == 'option4') echo 'selected'; ?>>ปัญหาการจราจรและอุบัติภัย</option>
                     <option value="option2" <?php if($row['Problem_type'] == 'option5') echo 'selected'; ?>>ปัญหาการระบายน้ำและน้ำท่วมขัง</option>
                     <option value="option3" <?php if($row['Problem_type'] == 'option6') echo 'selected'; ?>>ปัญหาความปลอดภัยในชีวิตและทรัพย์สินของประชาชน</option>
                     <option value="option1" <?php if($row['Problem_type'] == 'option7') echo 'selected'; ?>>ปัญหาชุมชนแออัดและแหล่งเสื่อมโทรม</option>
                     <option value="option2" <?php if($row['Problem_type'] == 'option8') echo 'selected'; ?>>ปัญหาแคลนสถานศึกษาในระดับประถมศึกษาและอนุบาล</option>
                     <option value="option3" <?php if($row['Problem_type'] == 'option9') echo 'selected'; ?>>ปัญหาการให้บริการทางด้านสาธารณสุข</option>
                  </select>
               </div>
            </div>
            <div class="form-group mb-3">
               <label class="form-label">รายละเอียด *</label>
               <?php echo $row['Problem_details'] ?>
