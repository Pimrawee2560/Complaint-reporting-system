...
$sql = "SELECT Evaluate_1, Evaluate_2, Evaluate_3, Evaluate_4, Evaluate_5 FROM building_control_form";
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'คะแนนความพึงพอใจแบบฟอร์มงานควบคุมอาคาร'
        },
        xAxis: {
        ...
        series: [{
            ...
            name: '4. การให้บริการเป็นไปตามระยะเวลาที่กำหนด ',
            data: Object.values(data['Evaluate_4'])
        }, {
            name: '5. การให้บริการตามลำดับก่อน-หลัง ',
