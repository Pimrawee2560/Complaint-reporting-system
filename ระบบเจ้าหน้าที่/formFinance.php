...
if (isset($_POST["submit"])) {
   ...
   $Financeandaccounting = $_POST['Financeandaccounting'];
   $Gender = $_POST['Gender'];
   $Age = $_POST['Age'];
   $Career = $_POST['Career'];
   ...
   $sql = "INSERT INTO `finance_and_accounting_form`(`id`, `Date`, `Financeandaccounting`, `Gender`, `Age`, `Career`, `Evaluate_1`, `Evaluate_2`, `Evaluate_3`, `Evaluate_4`, `Evaluate_5`, `Suggestion`) VALUES (NULL,'$Date','$Financeandaccounting','$Gender','$Age','$Career','$Evaluate_1','$Evaluate_2','$Evaluate_3','$Evaluate_4','$Evaluate_5','$Suggestion')";
...
<head>
    ...
    <title>งานการเงินและบัญชี</title>
</head>
<body>
    <form method="POST">
    <h1>งานการเงินและบัญชี</h1>
    <h4>กรุณากรอกข้อมูลให้ครบถ้วน</h4>
    <div>
        <label for="">งานการเงินและบัญชี</label><span class="required">*</span><br><br>
        <input type="radio" name="Financeandaccounting" value="การรับเงินและเบิกจ่ายเงิน" required> การรับเงินและเบิกจ่ายเงิน<br>
    </div><br>
    <div>
    ...
    <div>
        <label for="occupation">อาชีพ</label><span class="required">*</span><br><br>
    ...
    <h4>แบบฟอร์มการประเมินความพึงพอใจที่มีต่อการบริการ</h4><br>
        ...
        <div>
            <label for="">5. มีการเบิกจ่ายเงินถูกต้องตามระเบียบ กฎหมาย </label><span class="required">*</span><br><br>
