...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `building_control_form`(`id`, `Date`, `Building`, `Gender`, `Age`, `Career`, `Evaluate_1`, `Evaluate_2`, `Evaluate_3`, `Evaluate_4`, `Evaluate_5`, `Suggestion`) VALUES (NULL,'$Date','$Building','$Gender','$Age','$Career','$Evaluate_1','$Evaluate_2','$Evaluate_3','$Evaluate_4','$Evaluate_5','$Suggestion')";
...
<head>
    ...
    <title>งานควบคุมอาคาร</title>
</head>
<body>
    <form method="POST">
        <h1>งานควบคุมอาคาร</h1>
        <h4>กรุณากรอกข้อมูลให้ครบถ้วน</h4>
        <div>
            <label for="Building">งานควบคุมอาคาร</label><span class="required">*</span><br><br>
            <form action="/action_page.php">
            <p>กรุณาเลือก</p>
            <select id="" name="Building">
                <option value="งานควคุมอาคาร และสิ่งปลูกสร้าง">งานควบคุมอาคาร และสิ่งปลูกสร้าง</option>
                <option value="อนุญาตประกอบกิจการน้ำมันเชื้อเพลิง">อนุญาตประกอบกิจการน้ำมันเชื้อเพลิง</option>
                <option value="ขออนุญาต ขุดดิน ถมดิน">ขออนุญาต ขุดดิน ถมดิน</option>
                <option value="ชี้แนวเขต">ชี้แนวเขต</option>
                <option value="รับรองสิ่งปลูกสร้าง">รับรองสิ่งปลูกสร้าง</option>
                <option value="รับรองสิ่งปลูกสร้างเพื่อขอบ้านเลขที่">รับรองสิ่งปลูกสร้างเพื่อขอบ้านเลขที่</option>
            </select>
    </div><br>
    <div>
    ...
    <div>
        <label for="Evaluate_4">4. การให้บริการเป็นไปตามระยะเวลาที่กำหนด </label><span class="required">*</span><br><br>
    ...
    <div>
        <label for="Evaluate_5">5. การให้บริการตามลำดับก่อน-หลัง </label><span class="required">*</span><br><br>
