...
$sql = "SELECT Evaluate_1, Evaluate_2, Evaluate_3, Evaluate_4, Evaluate_5 FROM electrical_form";
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'คะแนนความพึงพอใจแบบฟอร์มงานไฟฟ้า'
        },
        xAxis: {
        ...
        series: [{
            ...
            name: '4. มีช่องทางการติดต่อแจ้งไฟฟ้าขัดข้อง หลายช่องทาง เช่น โทรศัพท์สำนักงาน กลุ่มไลน์',
            data: Object.values(data['Evaluate_4'])
        }, {
            name: '5. เจ้าหน้าที่ให้บริการด้วยความเต็มใจ และรวดเร็ว',
