...
$sql = "SELECT Evaluate_1, Evaluate_2, Evaluate_3, Evaluate_4, Evaluate_5 FROM administrative_form";
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'คะแนนความพึงพอใจแบบฟอร์มงานธุรการ'
        },
        xAxis: {
        ...
        series: [{
            ...
            name: '4. จำนวนครุภัณฑ์/อุปกรณ์ต่างๆ เพียงพอต่อความต้องการ ',
            data: Object.values(data['Evaluate_4'])
        }, {
            name: '5. ความพร้อมของอุปกรณ์/เครื่องมือ ที่ให้บริการ',
