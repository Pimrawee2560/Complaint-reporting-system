...
$sql = "SELECT Evaluate_1, Evaluate_2, Evaluate_3, Evaluate_4, Evaluate_5 FROM tax_collection_form";
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'คะแนนความพึงพอใจแบบฟอร์มงานป้องกันและบรรเทาสาธารณภัย'
        },
        xAxis: {
        ...
        series: [{
            ...
            name: '4. เจ้าหน้าที่ไม่มีการเรียกรับสินบนเพื่ออำนวยความสะดวกในการติดต่องานราชการ ',
            data: Object.values(data['Evaluate_4'])
        }, {
            name: '5. การดำเนินการจัดซื้อ/จัดจ้างมีความถูกต้อง เป็นธรรม โปร่งใส ',
