...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `administrative_form`(`id`, `Date`, `Administrative`, `Gender`, `Age`, `Career`, `Evaluate_1`, `Evaluate_2`, `Evaluate_3`, `Evaluate_4`, `Evaluate_5`, `Suggestion`) VALUES (NULL,'$Date','$Administrative','$Gender','$Age','$Career','$Evaluate_1','$Evaluate_2','$Evaluate_3','$Evaluate_4','$Evaluate_5','$Suggestion')";
...
<form method="POST">
        ...
        <div>
            <label for="Administrative">งานธุรการ</label> <span class="required">*</span><br><br>
            <input type="radio" name="Administrative" value="การขออนุญาตใช้สถานที่" required> การขออนุญาตใช้สถานที่<br>
            <input type="radio" name="Administrative" value="การขอยืมวัสดุ/อุปกรณ์"  required> การขอยืมวัสดุ/อุปกรณ์<br>
        </div><br>    
        <div>
        ...
        <div>
            ...
            <input type="radio" name="Age" value="ต่ำกว่า20ปี" required> ต่ำกว่า 20 ปี<br>
            <input type="radio" name="Age" value="20-30ปี" required> 20 - 30 ปี<br>
            <input type="radio" name="Age" value="31-40ปี" required> 31 - 40 ปี<br>
            <input type="radio" name="Age" value="41-50ปี" required> 41 - 50 ปี<br>
            <input type="radio" name="Age" value="51-60ปี" required> 51 - 60 ปี<br>
            <input type="radio" name="Age" value="60ปีขึ้นไป" required> 60 ปีขึ้นไป<br>
        </div><br>
        <div>
        ...
        <div>
            <label for="Evaluate_4">4. จำนวนครุภัณฑ์/อุปกรณ์ต่างๆ เพียงพอต่อความต้องการ </label><span class="required">*</span><br><br>
        ...
        <div>
            <label for="Evaluate_5">5. ความพร้อมของอุปกรณ์/เครื่องมือ ที่ให้บริการ </label><span class="required">*</span><br><br>
